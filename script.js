...
function addTask() {
    ...
    if (taskText === "") {
        var clip= new Audio("resources/error.mp3");
        clip.play();
        return;
    }
    ...
    const listItem = createTaskElement(task);
    taskList.appendChild(listItem);
    var clip= new Audio("resources/add.mp3");
    clip.play();
...
function createTaskElement(task) {
    ...
    listItem.innerHTML = `
        ...
        <button class="delete" onclick="removeTask(this)"><img src="resources/delete.png" height="150%"></button>
    `;
...
function removeTask(button) {
    ...
    listItem.remove();
    var clip= new Audio("resources/delete.mp3");
    clip.play();
